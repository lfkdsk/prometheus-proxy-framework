...
public class TextParserTest {
    ...
    static final class TestItem {
        ...
        final List<Collector.MetricFamilySamples> result;


        public TestItem(String input, boolean fail, String errorMsg, List<Collector.MetricFamilySamples> result) {
            this.input = input;
            this.fail = fail;
        ...
        public static TextParserTest.TestItem of(String input, boolean fail, String errorMsg, List<Collector.MetricFamilySamples> result) {
            return new TextParserTest.TestItem(input, fail, errorMsg, result);
        }

        public static TextParserTest.TestItem of(String input, boolean fail, String errorMsg) {
            return new TextParserTest.TestItem(input, fail, errorMsg, null);
        }

        public static TextParserTest.TestItem of(String input, List<Collector.MetricFamilySamples> result) {
            return new TextParserTest.TestItem(input, false, null, result);
        }
        ...
        static void testParser(TestItem test) {
            TextParser textParser = new TextParser(test.input);
            Map<String, Collector.MetricFamilySamples> metricFamilySamples = textParser.run(new StringReader(test.input));


//            assertEquals(metricFamilySamples, test.result);
        }
    ...
    public void testMinimalCase() {
        TestItem.of("minimal_metric 1.234\n" +
                        "another_metric -3e3 103948\n" +
                        "# Even that:\n" +
                        "no_labels{} 3\n" +
                        "# HELP line for non-existing metric will be ignored.\n",
                new ArrayList<Collector.MetricFamilySamples>() {{
                    add(new Collector.MetricFamilySamples("minimal_metric",
                            Collector.Type.UNTYPED,
                            null,
                            new ArrayList<Collector.MetricFamilySamples.Sample>() {{
                                add(new Collector.MetricFamilySamples.Sample("minimal_metric", Collections.emptyList(), Collections.emptyList(), 1.234));
                            }}));

                    add(new Collector.MetricFamilySamples("another_metric",
                            Collector.Type.UNTYPED,
                            null,
                            new ArrayList<Collector.MetricFamilySamples.Sample>(){{
                                add(new Collector.MetricFamilySamples.Sample("another_metric", Collections.emptyList(), Collections.emptyList(),-3e3,103948L));
                            }}));

                    add(new Collector.MetricFamilySamples("no_labels",
                            Collector.Type.UNTYPED,
                            null,
                            new ArrayList<Collector.MetricFamilySamples.Sample>(){{
                                add(new Collector.MetricFamilySamples.Sample("no_labels", Collections.emptyList(), Collections.emptyList(),3));
                            }}));
                }}).test();
    }
